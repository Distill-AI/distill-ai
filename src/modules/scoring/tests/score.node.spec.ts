...
describe('ScoreNode determinism', () => {
  ...
  it('two independent runs on identical inputs produce identical routing decisions', async () => {
    ...
    const payloadA = (a.requests.update as ReturnType<typeof vi.fn>).mock.calls[0][0].updatePayload;
    const payloadB = (b.requests.update as ReturnType<typeof vi.fn>).mock.calls[0][0].updatePayload;
