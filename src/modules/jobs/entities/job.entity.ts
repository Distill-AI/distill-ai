...
export class Job extends BaseEntity {
  ...
  // Optimistic lock expiry: the worker that claimed this job must complete
  // before this timestamp. The scheduler sweep resets PROCESSING jobs with an
  // expired lease back to PENDING so they can be re-claimed.
  @Column({ type: 'timestamptz', nullable: true })
