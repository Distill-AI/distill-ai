        ...
        <div className="flex items-center gap-6">
          <div>
            ...
            {queueLoading ? (
              ...
              <span
                className={`inline-flex items-center gap-1.5 text-sm font-semibold ${queueStatus?.paused ? 'text-orange-600' : 'text-green-600'}`}
              >
                <span
                  className={`inline-block w-2 h-2 rounded-full ${queueStatus?.paused ? 'bg-orange-500' : 'bg-green-500'}`}
                />
          ...
          <div>
            ...
            <span
              className={`text-sm font-semibold ${!queueLoading && (queueStatus?.workers ?? 0) === 0 ? 'text-red-600' : 'text-gray-900'}`}
            >
